...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="输入登录名" id="adminName" name="adminName">
		</div>
	</div>
	<div class="row cl">
...
$(function(){
	...
	$("#form-admin-add").validate({
		...
		submitHandler:function(form){
			...
			$(form).ajaxSubmit({
				type: 'post',
				url: "<%=request.getContextPath()%>/adminuser/toadd" ,
				data: {"adminName" : adminName, "password" : password, "password2" : password2, "phone" : phone, "email" : email, "selectRole" : selectRole},
				dataType: "json",
