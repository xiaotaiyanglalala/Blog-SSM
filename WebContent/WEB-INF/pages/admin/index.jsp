<%@page import="com.open.blog.config.Global"%>
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<%=request.getContextPath()%>/admin/welcome">十五度网络博客后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v3.0</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li><%=adminUser.getRole() == null ? "非管理用户" : adminUser.getRole().getName()%></li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A"><%=adminUser.getUsername() %> <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<li><a href="#">切换账户</a></li>
							<li><a href="<%=request.getContextPath()%>/admin/loginout">退出</a></li>
						</ul>
					</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="<%=request.getContextPath() %>/admin/articlelist" data-title="文章管理" href="javascript:void(0)">文章管理</a></li>
					<li><a data-href="<%=request.getContextPath() %>/article/add" data-title="文章添加" href="javascript:void(0)">文章添加</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="<%=request.getContextPath() %>/admin/adminrole" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a data-href="<%=request.getContextPath() %>/admin/adminpermission" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
					<li><a data-href="<%=request.getContextPath() %>/admin/adminlist" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
