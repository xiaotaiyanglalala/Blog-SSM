<%@page import="com.open.blog.entity.Secqurity"%>
...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<%
				List<Secqurity> secqurities = (List<Secqurity>) request.getAttribute("secqurities");
				if(secqurities != null && secqurities.size() > 0) {
					for(Secqurity secqurity : secqurities) {
			%>
			<tr class="text-c">
				<td><input type="checkbox" value="1" name=""></td>
				<td><%=secqurity.getId() %></td>
				<td><%=secqurity.getMenu_name() %></td>
				<td><%=secqurity.getDes() %></td>
