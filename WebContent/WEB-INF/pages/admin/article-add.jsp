...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="输入关键词" id="keywords" name="keywords">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文章摘要：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="articleintroduce" name="abstracts" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="输入文章来源" id="sources" name="sources">
			</div>
		</div>
		<!-- <div class="row cl">
...
$(function(){
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){
			...
			$.ajax({
				type : "POST",
				url : "<%=request.getContextPath()%>/article/toadd",
				...
				sources , 'allowcomments' : allowcomments , 'content' : content},
				dataType : "json",
